...
//
//   node scripts/serve.mjs [port]      then open http://127.0.0.1:5070/automated-donor-journeys/
//
...
console.log(`Serving ${DOCS_ROOT} at ${server.url}/automated-donor-journeys/`);
