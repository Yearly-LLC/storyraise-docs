...
Embed your Givebutter giving experience directly inside a Storyraise report, so the moment your story moves a reader, they can give — without leaving the page.
...
1. In the builder, go to the section where you want the giving experience — a **Donate** section works well.
2. Add the Givebutter element to a block.
3. Paste the URL of your Givebutter campaign or giving form.
4. Preview the section to confirm the form loads and looks right, including on mobile.

<!-- TEAM REVIEW: confirm the exact element name/label for the Givebutter embed in the builder, and which Givebutter URL types are supported (campaign page, giving form, both?). -->

## Tips

- **Place it after the story, not before.** Donation embeds convert best right after your most compelling impact section.
