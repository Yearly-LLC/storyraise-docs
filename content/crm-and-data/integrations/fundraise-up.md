...
In the **Connections** tab, find **Fundraise Up**, click **Connect**, and enter:

- **API Key** — your Fundraise Up API key.

Then **Connect & sync**.

## Where to find your key

Create an API key under **Settings → Integrations → API keys** in Fundraise Up. See the [Fundraise Up help center](https://help.fundraiseup.com/).
