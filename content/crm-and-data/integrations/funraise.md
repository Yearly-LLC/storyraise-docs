...
In the **Connections** tab, find **Funraise**, click **Connect**, and enter:
...
In your Funraise dashboard, go to **Settings → API** and create a key — copy it immediately, as it's shown only once. See the [Funraise API guide](https://help.funraise.io/en/articles/10518268-funraise-api).
