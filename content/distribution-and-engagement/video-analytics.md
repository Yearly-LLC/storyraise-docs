...
> **Coming soon** — viewing analytics for Storyraise Video are in development and not yet available.
...
<!-- TEAM REVIEW — internal outline for when video analytics ships (scaffolding exists; event listeners + video_analytics dataset were prototyped):
- Plays and unique viewers (per video, per recipient)
